...
<p>This privacy policy is applicable to the DLS KITS app (hereinafter referred to as
    "Application") for mobile devices, which was developed by devkevpe (hereinafter referred to as
    "Service Provider") as a a Free service. This service is provided "AS IS".</p><br><strong>What
    information does the Application obtain and how is it used?</strong><br><strong>User Provided
    Information</strong>
...
<br><strong>Automatically Collected Information</strong>
...
<p style="">This Application does not gather precise information about the location of your mobile
    device.</p>
...
<p>You can halt all collection of information by the Application easily by uninstalling the
    ...
    mobile device or via the mobile application marketplace or network.</p><br><strong>Data
    Retention Policy, Managing Your Information</strong>
<p>The Service Provider will retain User Provided data for as long as you use the Application and
    ...
    contact them at devkevpe@gmail.com and we will respond in a reasonable time. Please note that
...
<div><br>
    <p>The Application does not address anyone under the age of 13. The Service Provider does not
        ...
        information, please contact the Service Provider (devkevpe@gmail.com) so that they will be
        able to take the necessary actions.</p></div><!----><br><strong>Security</strong>
...
<p>This privacy policy is effective as of 2024-05-06</p><br><strong>Your Consent</strong>
<p>By using the Application, you are giving your consent to the Service Provider processing of your
    ...
    information.</p><br><strong>Contact us</strong>
<p>If you have any questions regarding privacy while using the Application, or have questions about
    the practices, please contact the Service Provider via email at devkevpe@gmail.com.</p>
<hr>
</body>
</html>
